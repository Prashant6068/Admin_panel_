...
<body>
  ...
  <h1 class="text-center ">Registration Panel</h1>
        ...
        <div class="container">
          ...
          <h4 class="py-3 text-dark">Register</h4>
            ...
            <div>
                    ...
                    <button type="submit" class="btn btn-dark " name="sub">Register</button>
                
                    <button type="submit" class="btn btn-danger"  name="already_exist">Already a user</button>
                </div>
